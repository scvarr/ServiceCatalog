...
GLPI_API_PAGE_SIZE = int(os.environ.get("GLPI_API_PAGE_SIZE", "100"))
GLPI_COMPONENT_WORKERS = int(os.environ.get("GLPI_COMPONENT_WORKERS", "6"))
GLPI_DB_BATCH_SIZE = int(os.environ.get("GLPI_DB_BATCH_SIZE", "200"))
